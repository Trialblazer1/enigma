'''
Enigma class for advanced portion of the project. This class implements the functionality of setting the rings to a given position,
setting the key to a given string of three characters and enciphers/deciphers a given character, returning us back with a corresponding
character output.
'''
